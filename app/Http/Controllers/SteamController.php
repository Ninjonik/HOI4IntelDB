            ...
            if ($hasHoi4) {
                ...
                if (empty($player->rating)) {
                    try {
                        ...
                        $description = "There has been an error with validating your steam account. This is caused by your steam account already being linked with another discord account. Once you resolve this issue you can try again. Feel free to Contact HOI4Intel's Staff.";
                    }
                } else {
                    try {
